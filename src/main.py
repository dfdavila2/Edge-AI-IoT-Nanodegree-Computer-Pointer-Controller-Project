...
def build_argparser():
    ...
    parser.add_argument("-fm", "--face_detection_model" required=True, type=str,
                        help="Path to the .xml file of the Face Detection model.")
   
    parser.add_argument("-hpm", "--head_pose_model", required=True, type=str,
                        help="Path to the .xml file of the Head Pose Estimation model.")
                        
    parser.add_argument("lm", "--landmarks_model", required=True, type=str,
                        help="Path to the .xml file of the Landmarks Regression Retail model.")
                        
    parser.add_argument("-gm", "--gaze_estimation_model", required=True, type=str,
                        help="Path to the .xml file of the Gaze Estimation model.")
